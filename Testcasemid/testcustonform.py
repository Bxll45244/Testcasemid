...
class Customer1(unittest.TestCase):
    ...
    def test_input1(self):
        ...
        self.driver.save_screenshot('cap1.png')
    ...
    def test_input2(self):
        ...
        submit = self.driver.find_element(By.ID, "submit")
        submit.click()
        self.driver.save_screenshot('cap2.png')
        result = self.driver.find_element(By.ID, "firstName").text
    ...
    def test_input3(self):
        ...
        self.driver.save_screenshot('cap3.png')
        result = self.driver.find_element(By.ID, "firstName").text
    ...
    def test_input4(self):
        ...
        self.driver.save_screenshot('cap4.png')
        result = self.driver.find_element(By.ID, "firstName").text
        self.assertEqual("First Name: Johnjohnjohnjo", result)
    ...
    def test_input5(self):
        ...
        self.driver.save_screenshot('cap5.png')
    ...
    def test_input6(self):
        ...
        self.driver.save_screenshot('cap6.png')
    ...
    def test_input8(self):
        ...
        self.driver.save_screenshot('cap8.png')
    ...
    def test_input10(self):
        ...
        self.driver.save_screenshot('cap10.png')
    ...
    def test_input11(self):
        ...
        self.driver.save_screenshot('cap11.png')
